...
namespace SFC_USB
{
    ...
    internal class frmMain : System.Windows.Forms.Form
    {
        ...
        const byte BOX485_MSG_SLAVE = 0x7E;
        ...
        const byte MCT_RESP_JUMP_TO_APP = 0x82;
        const byte MCT_RESP_ERASE_APP = 0x83;
        const byte MCT_RESP_BLANK_CHECK = 0x84;
        const byte MCT_RESP_PROG_APP = 0x85;
        const byte MCT_RESP_READ_FLASH = 0x86;
        const byte MCT_RESP_FLASH_CKSUM = 0x87;
        const byte MCT_RESP_JUMP_TO_BOOT = 0x88;
        const byte MCT_RESP_GET_STRING = 0x97;
        const byte MCT_RESP_POSN = 0xA0;
        const byte MCT_RESP_TARGET = 0xA1;
        const byte MCT_RESP_GET_MIRRORS = 0xC0;
        const byte MCT_RESP_PARAM = 0xC1;
        const byte USB_CMD_GET_VSTRING = 0x17;
        const byte USB_CMD_GET_CHAN = 0x33;
        const byte USB_CMD_GET_MIRRORS = 0x42;
        const byte USB_CMD_GET_STRING = 0x60;
        const byte USB_CMD_FIELD_STATE = 0x61;
        const byte USB_CMD_GET_FCE = 0x62;
        const byte USB_CMD_GET_RTU = 0x63;
        const byte USB_CMD_SEND_MCT485 = 0x64;
        const byte USB_CMD_GET_MCT485 = 0x65;
        const byte USB_CMD_RTC = 0x66;
        const byte USB_CMD_DESICCANT = 0x68;
        const byte USB_CMD_SFC_PARAM = 0x69;
        const byte USB_CMD_MEMORY = 0x6A;
        const byte USB_CMD_TEST = 0x6B;
        const byte USB_RESP_GET_VSTRING = 0x97;
        const byte USB_RESP_GET_CHAN = 0xB3;
        const byte USB_RESP_GET_MIRRORS = 0xC2;
        const byte USB_RESP_GET_STRING = 0xE0;
        const byte USB_RESP_FIELD_STATE = 0xE1;
        const byte USB_RESP_GET_FCE = 0xE2;
        const byte USB_RESP_GET_RTU = 0xE3;
        const byte USB_RESP_SEND_MCT485 = 0xE4;
        const byte USB_RESP_GET_MCT485 = 0xE5;
        const byte USB_RESP_RTC = 0xE6;
        const byte USB_RESP_DESICCANT = 0xE8;
        const byte USB_RESP_SFC_PARAM = 0xE9;
        const byte USB_RESP_MEMORY = 0xEA;
        const byte USB_RESP_TEST = 0xEB;
        ...
        const byte USB_PACKET_STR = 0;
        const byte USB_PACKET_MCT = 1;
        const byte USB_PACKET_LEN = 2;
        const byte USB_PACKET_PID = 3;
        const byte USB_PACKET_CMD = 4;
        const byte USB_PACKET_DATA = 5;
            ...
            : base()
        {
            ...
            paramStartWrite = 128;
            paramStopWrite = 0;
            if (File.Exists("MCTvalues.txt"))
            {
                String line;
                char[] delimiterChars = { ' ', ',', '.', ':', '\t' };
                StreamReader MCTvalues = File.OpenText("MCTvalues.txt");
        ...
        private void InitializeComponent()
        {
            ...
            this.label95.Size = new System.Drawing.Size(64, 14);
            ...
            this.label96.Size = new System.Drawing.Size(64, 14);
            ...
            this.cbValve.Size = new System.Drawing.Size(54, 18);
            ...
            this.label80.Size = new System.Drawing.Size(99, 14);
            ...
            this.label79.Size = new System.Drawing.Size(31, 14);
            ...
            this.label74.Size = new System.Drawing.Size(31, 14);
            ...
            this.label68.Size = new System.Drawing.Size(66, 14);
            ...
            this.label45.Size = new System.Drawing.Size(54, 14);
            ...
            this.label58.Size = new System.Drawing.Size(54, 14);
            ...
            this.tabDataLog.Location = new System.Drawing.Point(4, 22);
            this.tabDataLog.Name = "tabDataLog";
            this.tabDataLog.Size = new System.Drawing.Size(760, 410);
            ...
            this.checkRecSFCTemp.Size = new System.Drawing.Size(156, 18);
            ...
            this.checkRecPCBTemp.Size = new System.Drawing.Size(119, 18);
            ...
            this.tabTesting.Size = new System.Drawing.Size(760, 410);
            ...
            this.radioStringA.Size = new System.Drawing.Size(64, 18);
            ...
            this.Text = "SFC USB          updated 5/17/2011";
        ...
        private void GetReceivedBulkData(IAsyncResult ar)
        {
            ...
            try
            {
                ...
                {
                    if (rxBuffer[USB_PACKET_PID] == txBuffer[USB_PACKET_PID])
                    {
                        cmdComplete = true;
                    }
                    else
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (flagRamDump)
            {
                ...
                StreamWriter ramFile = File.AppendText("SFC Ram Dump.txt");
                string line;
                ...
                {
                    txBuffer[USB_PACKET_DATA + 0] = (byte)(addr >> 24);
                    txBuffer[USB_PACKET_DATA + 1] = (byte)(addr >> 16);
                    txBuffer[USB_PACKET_DATA + 2] = (byte)(addr >> 8);
                    txBuffer[USB_PACKET_DATA + 3] = (byte)addr;
                    SendTxMessage(0, 0, USB_RESP_MEMORY);
                    line = addr.ToString("X8") + ":";
                    for (int i = 0; i < 16; i++)
                    {
                        line += " " + rxBuffer[USB_PACKET_DATA + 5 + i].ToString("X2");
                    }
                    ramFile.WriteLine(line);
                }
                ramFile.Close();
            ...
            {
                flagTestBtn = false;
                SendTxMessage(0, 0, USB_CMD_TEST);
            ...
            else if (flagGetString)
            {
                flagGetString = false;
                // read String info
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_GET_STRING);
                SendTxMessage(WhichStringRadio(), pollMct, USB_RESP_FIELD_STATE);
            }
            else if (flagSetFieldOff)
            {
                flagSetFieldOff = false;
                lstResults.Items.Add("Setting field to OFF");
                txBuffer[USB_PACKET_DATA] = FIELD_OFF;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_FIELD_STATE);
            }
            else if (flagSetFieldShutdown)
            {
                flagSetFieldShutdown = false;
                lstResults.Items.Add("Setting field to END OF DAY");
                txBuffer[USB_PACKET_DATA] = FIELD_END_OF_DAY;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_FIELD_STATE);
            }
            else if (flagSetFieldTest)
            {
                ...
                txBuffer[USB_PACKET_DATA] = FIELD_TEST;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_FIELD_STATE);
            ...
            else if (flagSetFieldTestOnSun)
            {
                ...
                txBuffer[USB_PACKET_DATA] = FIELD_TEST_ON_SUN;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_FIELD_STATE);
                for (int i = 0; i < 4; i++)
                {
                    byte radio = WhichStringRadio();
            ...
            else if (flagSetFieldTestOff)
            {
                ...
                txBuffer[USB_PACKET_DATA] = FIELD_TEST_OFF;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_FIELD_STATE);
            }
            else if (flagSetFieldTestShutdown)
            {
                ...
                txBuffer[USB_PACKET_DATA] = FIELD_TEST_END_OF_DAY;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_FIELD_STATE);
            }
            else if (flagSetFieldLogging)
            {
                ...
                txBuffer[USB_PACKET_DATA] = FIELD_LOGGING;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_FIELD_STATE);
            }
            else if (flagSetFieldLoggingOff)
            {
                ...
                txBuffer[USB_PACKET_DATA] = FIELD_LOGGING_OFF;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_FIELD_STATE);
            }
            else if (flagHomeString)
            {
                ...
                txBuffer[USB_PACKET_DATA] = pollMct;
                txBuffer[USB_PACKET_DATA + 1] = txPid;
                txBuffer[USB_PACKET_DATA + 2] = 11;
                txBuffer[USB_PACKET_DATA + 3] = MCT_CMD_POSN;
                txBuffer[USB_PACKET_DATA + 4] = 0x03;
                txBuffer[USB_PACKET_DATA + 5] = (byte)(2395 >> 8);
                txBuffer[USB_PACKET_DATA + 6] = (byte)(2395 & 0xFF);
                txBuffer[USB_PACKET_DATA + 7] = (byte)(2395 >> 8);
                txBuffer[USB_PACKET_DATA + 8] = (byte)(2395 & 0xFF);
                TxCrcCalc(5, 9);
                txBuffer[USB_PACKET_MCT] = pollMct;
                txBuffer[USB_PACKET_LEN] = 18;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_SEND_MCT485);
                ...
                txBuffer[USB_PACKET_DATA + 2] = 11;
                txBuffer[USB_PACKET_DATA + 3] = MCT_CMD_POSN;
                txBuffer[USB_PACKET_DATA + 4] = 0x13;
                txBuffer[USB_PACKET_DATA + 5] = (byte)(2395 >> 8);
                txBuffer[USB_PACKET_DATA + 6] = (byte)(2395 & 0xFF);
                txBuffer[USB_PACKET_DATA + 7] = (byte)(2395 >> 8);
                txBuffer[USB_PACKET_DATA + 8] = (byte)(2395 & 0xFF);
                ...
                txBuffer[USB_PACKET_DATA + 1] = txPid;
                txBuffer[USB_PACKET_DATA + 2] = 11;
                txBuffer[USB_PACKET_DATA + 3] = MCT_CMD_TARGET;
                txBuffer[USB_PACKET_DATA + 4] = 0x03;
                txBuffer[USB_PACKET_DATA + 5] = 0;
                txBuffer[USB_PACKET_DATA + 6] = 0;
                txBuffer[USB_PACKET_DATA + 7] = 0;
                txBuffer[USB_PACKET_DATA + 8] = 0;
                TxCrcCalc(5, 9);
                txBuffer[USB_PACKET_MCT] = pollMct;
                txBuffer[USB_PACKET_LEN] = 18;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_SEND_MCT485);
            ...
            else if (flagMctMoveSteps1)
            {
                ...
                txBuffer[USB_PACKET_DATA + 3] = MCT_CMD_TARGET;
                txBuffer[USB_PACKET_DATA + 4] = 0x03;
                txBuffer[USB_PACKET_DATA + 5] = (byte)(Convert.ToInt16(txtMctMoveSteps1.Text) >> 8);
                txBuffer[USB_PACKET_DATA + 6] = (byte)Convert.ToInt16(txtMctMoveSteps1.Text);
                txBuffer[USB_PACKET_DATA + 7] = (byte)(Convert.ToInt16(txtMctMoveSteps1.Text) >> 8);
                txBuffer[USB_PACKET_DATA + 8] = (byte)Convert.ToInt16(txtMctMoveSteps1.Text);
                TxCrcCalc(5, 9);
                txBuffer[USB_PACKET_MCT] = pollMct;
                txBuffer[USB_PACKET_LEN] = 18;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_SEND_MCT485);
            ...
            else if (flagMctMoveSteps2)
            {
                ...
                txBuffer[USB_PACKET_DATA + 3] = MCT_CMD_TARGET;
                txBuffer[USB_PACKET_DATA + 4] = 0x13;
                txBuffer[USB_PACKET_DATA + 5] = (byte)(Convert.ToInt16(txtMctMoveSteps2.Text) >> 8);
                txBuffer[USB_PACKET_DATA + 6] = (byte)Convert.ToInt16(txtMctMoveSteps2.Text);
                txBuffer[USB_PACKET_DATA + 7] = (byte)(Convert.ToInt16(txtMctMoveSteps2.Text) >> 8);
                txBuffer[USB_PACKET_DATA + 8] = (byte)Convert.ToInt16(txtMctMoveSteps2.Text);
                TxCrcCalc(5, 9);
                txBuffer[USB_PACKET_MCT] = pollMct;
                txBuffer[USB_PACKET_LEN] = 18;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_SEND_MCT485);
            ...
            else if (flagMctChangeTrack1)
            {
                ...
                txBuffer[USB_PACKET_DATA] = pollMct;
                txBuffer[USB_PACKET_DATA + 1] = txPid;
                txBuffer[USB_PACKET_DATA + 2] = 8;
                txBuffer[USB_PACKET_DATA + 3] = MCT_CMD_TRACK;
                txBuffer[USB_PACKET_DATA + 4] = 0;
                txBuffer[USB_PACKET_DATA + 5] = trackNum[cbMctTrack1.SelectedIndex];
                TxCrcCalc(5, 6);
                txBuffer[USB_PACKET_MCT] = pollMct;
                txBuffer[USB_PACKET_LEN] = 15;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_SEND_MCT485);
                Mct485WaitResp(WhichStringRadio(), pollMct);
            }
            else if (flagMctChangeTrack2)
            {
                ...
                txBuffer[USB_PACKET_DATA + 2] = 8;
                txBuffer[USB_PACKET_DATA + 3] = MCT_CMD_TRACK;
                txBuffer[USB_PACKET_DATA + 4] = 1;
                txBuffer[USB_PACKET_DATA + 5] = trackNum[cbMctTrack2.SelectedIndex];
                TxCrcCalc(5, 6);
                txBuffer[USB_PACKET_MCT] = pollMct;
                txBuffer[USB_PACKET_LEN] = 15;
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_SEND_MCT485);
            ...
            else if (flagWriteAllParam)
            {
                ...
                for (int i = 0; i < PARAM_NUM_VALUES && i < numParamEntries; i++)
                {
                    if (paramEnable[i].Checked)
                    {
                        ...
                        {
                            txBuffer[USB_PACKET_DATA] = j;
                            txBuffer[USB_PACKET_DATA + 1] = txPid;
                            txBuffer[USB_PACKET_DATA + 2] = 9;
                            txBuffer[USB_PACKET_DATA + 3] = MCT_CMD_PARAM;
                            txBuffer[USB_PACKET_DATA + 4] = (byte)paramNum[i];
                            txBuffer[USB_PACKET_DATA + 5] = (byte)(Convert.ToInt16(paramDefaultText[i].Text) >> 8);
                            txBuffer[USB_PACKET_DATA + 6] = (byte)(Convert.ToInt16(paramDefaultText[i].Text));
                            TxCrcCalc(5, 7);
                            txBuffer[USB_PACKET_MCT] = (byte)(mctMaxAddr[WhichStringRadio()] | 0x40);
                            txBuffer[USB_PACKET_LEN] = 16;
                            SendTxMessage(WhichStringRadio(), j, USB_CMD_SEND_MCT485);
            ...
            else if (flagWriteParam != 0)
            {
                lstResults.Items.Add("Writing Parameters to MCT #" + flagWriteParam.ToString());
                ...
                for (int i = 0; i < PARAM_NUM_VALUES && i < numParamEntries; i++)
                {
                    ...
                    {
                        lstResults.Items.Add("Writing param " + paramLabel[i]);
                        txBuffer[USB_PACKET_DATA] = (byte)(flagWriteParam);
                        txBuffer[USB_PACKET_DATA + 1] = txPid;
                        txBuffer[USB_PACKET_DATA + 2] = 9;
                        txBuffer[USB_PACKET_DATA + 3] = MCT_CMD_PARAM;
                        txBuffer[USB_PACKET_DATA + 4] = (byte)paramNum[i];
                        ...
                        txBuffer[USB_PACKET_DATA + 6] = (byte)(Convert.ToInt16(paramDefaultText[i].Text));
                        TxCrcCalc(5, 7);
                        txBuffer[USB_PACKET_MCT] = (byte)(flagWriteParam);
                        txBuffer[USB_PACKET_LEN] = 16;
                        SendTxMessage(WhichStringRadio(), (byte)flagWriteParam, USB_CMD_SEND_MCT485);
                        Mct485WaitResp(WhichStringRadio(), (byte)flagWriteParam);
                    }
                }
                flagWriteParam = 0;
                lstResults.Items.Add("Done writing");
            ...
            else if (flagReadAllParam)
            {
                ...
                for (byte mct = 1; mct <= mctMaxAddr[WhichStringRadio()]; mct++)
                {
                    for (int i = 0; i < PARAM_NUM_VALUES; i++)
                    {
                        ...
                        txBuffer[USB_PACKET_DATA] = mct;
                        txBuffer[USB_PACKET_DATA + 1] = txPid;
                        txBuffer[USB_PACKET_DATA + 2] = 7;
                        txBuffer[USB_PACKET_DATA + 3] = MCT_CMD_PARAM;
                        txBuffer[USB_PACKET_DATA + 4] = (byte)paramNum[i];
                        TxCrcCalc(5, 5);
                        txBuffer[USB_PACKET_MCT] = mct;
                        txBuffer[USB_PACKET_LEN] = 14;
                        SendTxMessage(WhichStringRadio(), mct, USB_CMD_SEND_MCT485);
            ...
            {
                flagSetClock = false;
                txBuffer[USB_PACKET_DATA] = (byte)DateTime.Now.Second;
                txBuffer[USB_PACKET_DATA + 1] = (byte)DateTime.Now.Minute;
                txBuffer[USB_PACKET_DATA + 2] = (byte)DateTime.Now.Hour;
                txBuffer[USB_PACKET_DATA + 3] = (byte)DateTime.Now.Day;
                txBuffer[USB_PACKET_DATA + 4] = (byte)DateTime.Now.Month;
                txBuffer[USB_PACKET_DATA + 5] = (byte)(DateTime.Now.Year - 2000);
                SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_RTC);
            }
            else if (flagSetDesiccant)
            {
                flagSetDesiccant = false;
                SendTxMessage(0, 0, USB_CMD_DESICCANT);
            }
            else if (paramStartRead < paramStopRead)
            {
                if (paramStartRead < 128)
                {
                    txBuffer[USB_PACKET_DATA] = (byte)paramStartRead;
                    SendTxMessage(0, 0, USB_RESP_SFC_PARAM);
                    paramStartRead += 10;
                }
                else
                {
            ...
            else if (paramStartWrite < paramStopWrite)
            {
                ...
                {
                    int i;
                    txBuffer[USB_PACKET_DATA] = (byte)paramStartWrite;
                    i = 0;
                    while (i < 10 && paramStartWrite < paramStopWrite)
                    {
                        txBuffer[USB_PACKET_DATA + i * 4 + 1] = (byte)(sfcParam[paramStartWrite] >> 24);
                        txBuffer[USB_PACKET_DATA + i * 4 + 2] = (byte)(sfcParam[paramStartWrite] >> 16);
                        txBuffer[USB_PACKET_DATA + i * 4 + 3] = (byte)(sfcParam[paramStartWrite] >> 8);
                        txBuffer[USB_PACKET_DATA + i * 4 + 4] = (byte)sfcParam[paramStartWrite];
                        paramStartWrite++;
                        i++;
                    }
                    txBuffer[USB_PACKET_LEN] = (byte)(USB_PACKET_DATA + i * 4 + 3);
                    SendTxMessage(0, 0, USB_CMD_SFC_PARAM);
                }
                else
                {
                    paramStartWrite = 0;
            ...
            else if (tabCtrl.SelectedIndex == tabString.TabIndex)
            {
                ...
                else if (stringState[WhichStringRadio()] == STRING_ACTIVE)
                {
                    if (pollMct <= mctMaxAddr[WhichStringRadio()])
                    {
                        if (pollType == POLL_CHANNELS)
                        {
                            SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_GET_CHAN);
                            pollType = POLL_MIRRORS;
                        }
                        else if (pollType == POLL_MIRRORS)
                        {
                            SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_GET_MIRRORS);
                            pollType = POLL_CHANNELS;
                            pollMct++;
                        }
                    }
            ...
            else if (tabCtrl.SelectedIndex == tabSFC.TabIndex)
            {
                ...
                {
                    SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_GET_VSTRING);
                    pollType = POLL_FCE;
                }
                else if (pollType == POLL_FCE)
                {
                    // read String info
                    SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_GET_FCE);
                    pollType = POLL_RTU;
                }
                else if (pollType == POLL_RTU)
                {
                    // read String info
                    SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_GET_RTU);
                    pollType = POLL_RTC;
                }
                else if (pollType == POLL_RTC)
                {
                    // read String info
                    SendTxMessage(WhichStringRadio(), pollMct, USB_RESP_RTC);
                    pollType = POLL_DESICCANT;
                }
                else
                {
                    SendTxMessage(WhichStringRadio(), pollMct, USB_RESP_DESICCANT);
                    pollType = POLL_FCE;
                }
            }
            else if (tabCtrl.SelectedIndex == tabMCTfw.TabIndex)
            {
                ...
                if (flagGetMctVersions)
                {
                    ...
                    for (mct = 1; mct <= mctMaxAddr[WhichStringRadio()]; mct++)
                    {
                        ...
                        txBuffer[USB_PACKET_DATA + 1] = txPid;
                        txBuffer[USB_PACKET_DATA + 2] = 7;
                        txBuffer[USB_PACKET_DATA + 3] = MCT_CMD_GET_STRING;
                        txBuffer[USB_PACKET_DATA + 4] = 0;
                        TxCrcCalc(5, 5);
                        txBuffer[USB_PACKET_LEN] = 14;
                        SendTxMessage(WhichStringRadio(), mct, USB_CMD_SEND_MCT485);
            ...
            else if (tabCtrl.SelectedIndex == tabMctControl.TabIndex)
            {
                if (cbMctPollAddr.Items.Count > 0)
                {
                    ...
                    else if (pollType == POLL_ERROR1 || pollType == POLL_ERROR2)
                    {
                        ...
                        txBuffer[USB_PACKET_DATA + 2] = 7;
                        txBuffer[USB_PACKET_DATA + 3] = MCT_CMD_PARAM;
                        txBuffer[USB_PACKET_DATA + 4] = (byte)(126 + pollType - POLL_ERROR1);
                        TxCrcCalc(5, 5);
                        txBuffer[USB_PACKET_MCT] = pollMct;
                        txBuffer[USB_PACKET_LEN] = 14;
                        SendTxMessage(WhichStringRadio(), pollMct, USB_CMD_SEND_MCT485);
        ...
        {
            txBuffer[USB_PACKET_CMD] = cmd;
            txBuffer[USB_PACKET_STR] = str;
            usbGetResp = true;
            switch (txBuffer[USB_PACKET_CMD])
            {
                case USB_CMD_GET_VSTRING:
                    txBuffer[USB_PACKET_MCT] = mct;
                    txBuffer[USB_PACKET_LEN] = 7;
                    break;
                ...
                case USB_CMD_GET_STRING:
                    txBuffer[USB_PACKET_MCT] = 0;
                    txBuffer[USB_PACKET_LEN] = 7;
                    break;
                case USB_CMD_FIELD_STATE:
                    txBuffer[USB_PACKET_MCT] = 0;
                    txBuffer[USB_PACKET_LEN] = 8;
                    break;
                case USB_RESP_FIELD_STATE:
                    txBuffer[USB_PACKET_CMD] = USB_CMD_FIELD_STATE;
                    txBuffer[USB_PACKET_MCT] = 0;
                    txBuffer[USB_PACKET_LEN] = 7;
                    break;
                ...
                case USB_CMD_GET_RTU:
                    ...
                    txBuffer[USB_PACKET_LEN] = 7;
                    break;
                case USB_CMD_SEND_MCT485:
                    break;
                case USB_CMD_GET_MCT485:
                    txBuffer[USB_PACKET_LEN] = 7;
                    break;
                case USB_CMD_DESICCANT:
                    txBuffer[USB_PACKET_LEN] = 9;
                    txBuffer[USB_PACKET_DATA] = desiccantNewState;
                    txBuffer[USB_PACKET_DATA+1] = desiccantNewOutputs;
                    break;
                case USB_CMD_RTC:
                    txBuffer[USB_PACKET_LEN] = 13;
                    break;
                case USB_CMD_SFC_PARAM:
                    // length is set in the paramStartWrite, paramStopWrite section above
                    break;
                case USB_CMD_TEST:
                    usbGetResp = false;
                    txBuffer[USB_PACKET_LEN] = 8;
                    txBuffer[USB_PACKET_DATA] = (byte)testBtnValue;
                    break;
                case USB_RESP_RTC:
                    txBuffer[USB_PACKET_CMD] = USB_CMD_RTC;
                    txBuffer[USB_PACKET_LEN] = 7;
                    break;
                case USB_RESP_DESICCANT:
                    txBuffer[USB_PACKET_CMD] = USB_CMD_DESICCANT;
                    txBuffer[USB_PACKET_LEN] = 7;
                    break;
                case USB_RESP_SFC_PARAM:
                    txBuffer[USB_PACKET_CMD] = USB_CMD_SFC_PARAM;
                    txBuffer[USB_PACKET_LEN] = 8;
                    break;
                case USB_RESP_MEMORY:
                    txBuffer[USB_PACKET_CMD] = USB_CMD_MEMORY;
                    txBuffer[USB_PACKET_LEN] = 11;
                    break;
            }

            txBuffer[USB_PACKET_PID] = ++txPid;
            TxCrcCalc(0, (byte)(txBuffer[USB_PACKET_LEN] - 2));
        ...
        public void ProcessUsbResp() {
            int str = rxBuffer[USB_PACKET_STR];
            int mct = rxBuffer[USB_PACKET_MCT];
            if (mct <= 0 || mct > 10)
            {
                mct = 0;
            }
            ...
            switch (rxBuffer[USB_PACKET_CMD])
            {
                case USB_RESP_GET_VSTRING: // 0x97
                    txtVersString.Text = "";
                    for (int i = 0; i < 20; i++)
                    {
                        if (rxBuffer[USB_PACKET_DATA + i] != '\0')
                        {
                            txtVersString.Text += (char)rxBuffer[USB_PACKET_DATA + i];
                        }
                        else
                        {
                            break;
                ...
                case USB_RESP_GET_CHAN:    // 0xB3
                    if (rxBuffer[USB_PACKET_MCT] > 0 && rxBuffer[USB_PACKET_MCT] <= 10)
                    {
                        ...
                        if (tabCtrl.SelectedIndex == tabMctControl.TabIndex && str == WhichStringRadio() && pollMct == rxBuffer[USB_PACKET_MCT])
                        {
                        ...
                        {
                            DrawMctDeg(5 + 2 * MCT_RTD_TRACKLEFT_1A, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_RTD1AL]);
                            DrawMctDeg(5 + 2 * MCT_RTD_TRACKRIGHT_1A, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_RTD1AR]);
                            DrawMctDeg(5 + 2 * MCT_RTD_TRACKLEFT_1B, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_RTD1BL]);
                            DrawMctDeg(5 + 2 * MCT_RTD_TRACKRIGHT_1B, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_RTD1BR]);
                            DrawMctDeg(5 + 2 * MCT_RTD_MANIFOLD_1, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_RTD1MAN]);
                            DrawMctDeg(5 + 2 * MCT_RTD_TRACKLEFT_2A, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_RTD2AL]);
                            DrawMctDeg(5 + 2 * MCT_RTD_TRACKRIGHT_2A, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_RTD2AR]);
                            DrawMctDeg(5 + 2 * MCT_RTD_TRACKLEFT_2B, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_RTD2BL]);
                            DrawMctDeg(5 + 2 * MCT_RTD_TRACKRIGHT_2B, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_RTD2BR]);
                            DrawMctDeg(5 + 2 * MCT_RTD_MANIFOLD_2, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_RTD2MAN]);
                        }
                    }
                    break;
                case USB_RESP_GET_MIRRORS: // 0xC2
                    if (rxBuffer[USB_PACKET_MCT] > 0 && rxBuffer[USB_PACKET_MCT] <= 10)
                    {
                        ...
                        {
                            DrawstrMctTextTrack(5, rxBuffer[USB_PACKET_MCT] - 1, TXT_TRACK1);
                            DrawstrMctTextTrack(11, rxBuffer[USB_PACKET_MCT] - 1, TXT_TRACK2);
                            //DrawstrMctTextMdeg(7, rxBuffer[USB_PACKET_MCT] - 1, TXT_POSN1A);
                            //DrawstrMctTextMdeg(9, rxBuffer[USB_PACKET_MCT] - 1, TXT_POSN1B);
                            //DrawstrMctTextMdeg(13, rxBuffer[USB_PACKET_MCT] - 1, TXT_POSN2A);
                            //DrawstrMctTextMdeg(15, rxBuffer[USB_PACKET_MCT] - 1, TXT_POSN2B);
                            DrawMctMdeg(7, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_POSN1A]);
                            DrawMctMdeg(9, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_POSN1B]);
                            DrawMctMdeg(13, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_POSN2A]);
                            DrawMctMdeg(15, strMctText[rxBuffer[USB_PACKET_MCT] - 1, TXT_POSN2B]);
                        }
                    }
                    break;
                ...
                case USB_RESP_GET_MCT485:
                    if ((rxBuffer[USB_PACKET_MCT] & 0x80) == 0x80)
                    {
                        // response address should have the host bit set
                        rxBuffer[USB_PACKET_MCT] &= 0x7F;
                        mct = rxBuffer[USB_PACKET_MCT] - 1;
                    }
                    else
                    {
                        rxBuffer[USB_PACKET_MCT] = 0;
                        mct = 0;
                    }
                    switch (rxBuffer[8])
                    {
                        case MCT_RESP_GET_STRING:
                            if (rxBuffer[USB_PACKET_MCT] > 0 && rxBuffer[USB_PACKET_MCT] <= 10 && rxBuffer[7] == 48 && rxBuffer[USB_PACKET_LEN] == 55)
                            {
                            ...
                            else if (rxBuffer[USB_PACKET_LEN] > 7)
                            {
                                string s;
                                s = "ERR - Get Vers:";
                                for (int i = 0; i < rxBuffer[USB_PACKET_LEN]; i++) {
                                    s += ' ';
                ...
                case USB_RESP_RTC:
                    ...
                    {
                        if (rxBuffer[USB_PACKET_DATA + 2] == 0) {
                            txtRTC.Text = "12";
                        }
                        else if (rxBuffer[USB_PACKET_DATA + 2] <= 12) {
                            txtRTC.Text = rxBuffer[USB_PACKET_DATA + 2].ToString("D2");
                        }
                        else {
                            txtRTC.Text = (rxBuffer[USB_PACKET_DATA + 2]-12).ToString("D2");
                        }
                        txtRTC.Text += ":" + rxBuffer[USB_PACKET_DATA + 1].ToString("D2");
                        txtRTC.Text += ":" + rxBuffer[USB_PACKET_DATA].ToString("D2");
                        if (rxBuffer[USB_PACKET_DATA + 2] < 12) {
                            txtRTC.Text += "am";
                        }
                        else {
                            txtRTC.Text += "pm";
                        }
                        txtRTC.Text += " " + rxBuffer[USB_PACKET_DATA + 4].ToString("D2");
                        txtRTC.Text += "-" + rxBuffer[USB_PACKET_DATA + 3].ToString("D2");
                        txtRTC.Text += "-20" + rxBuffer[USB_PACKET_DATA + 5].ToString("D2");
                        sfcPcbTemp = RespChan(USB_PACKET_DATA + 6);
                        sfcThermistor = RespChan(USB_PACKET_DATA + 8);
                        sfcHumidity = RespChan(USB_PACKET_DATA + 10);
                        DrawSfcTemps();
                    }
                    break;
                case USB_RESP_DESICCANT:
                    if (rxBuffer[USB_PACKET_LEN] != 9)
                    {
                        // incorrect length, ignore packet
                    }
                    else if (tabCtrl.SelectedIndex == tabSFC.TabIndex)
                    {
                        ...
                        if (rxBuffer[USB_PACKET_DATA] == DESICCANT_OFF)
                            radioDesOff.Checked = true;
                        else if (rxBuffer[USB_PACKET_DATA] == DESICCANT_DRYING)
                            radioDesDrying.Checked = true;
                        else if (rxBuffer[USB_PACKET_DATA] == DESICCANT_REGEN)
                            radioDesRegen.Checked = true;
                        else if (rxBuffer[USB_PACKET_DATA] == DESICCANT_CLOSED)
                            radioDesClosed.Checked = true;
                        else if (rxBuffer[USB_PACKET_DATA] == DESICCANT_MANUAL)
                            radioDesManual.Checked = true;
                        cbFan.Checked = ((rxBuffer[USB_PACKET_DATA+1] & FCE_OUT_FAN) != 0);
                        cbValve.Checked = ((rxBuffer[USB_PACKET_DATA+1] & FCE_OUT_VALVE) != 0);
                        cbHeat.Checked = ((rxBuffer[USB_PACKET_DATA+1] & FCE_OUT_HEAT) != 0);
                    ...
                    break;
                case USB_RESP_SFC_PARAM:
                    if (rxBuffer[USB_PACKET_LEN] != 47)
                    {
                        // incorrect length, ignore packet
                    }
                    else
                    {
                        int paramNum = rxBuffer[USB_PACKET_DATA];
                        int i = 0;
                        while (paramNum < 128 && i < 40)
                        {
                            sfcParam[paramNum] = rxBuffer[USB_PACKET_DATA + i + 1];
                            sfcParam[paramNum] *= 256;
                            sfcParam[paramNum] += rxBuffer[USB_PACKET_DATA + i + 2];
                            sfcParam[paramNum] *= 256;
                            sfcParam[paramNum] += rxBuffer[USB_PACKET_DATA + i + 3];
                            sfcParam[paramNum] *= 256;
                            sfcParam[paramNum] += rxBuffer[USB_PACKET_DATA + i + 4];
        ...
        private void btnUpdateMctMaster_Click(object sender, EventArgs e)
        {
            ...
            if (File.Exists(txtFwMaster.Text))
            {
                ...
                txBuffer[USB_PACKET_DATA] = FIELD_TEST_UPDATE;
                ...
                {
                    SetStringRadio(stringNum);
                    SendTxMessage(stringNum, pollMct, USB_CMD_GET_STRING);
                    SendTxMessage(stringNum, pollMct, USB_RESP_FIELD_STATE);
                    if (mctStart == 0)
                    {
                        mctStart = 1;
                    ...
                    {
                        StreamReader sRecord = File.OpenText(txtFwMaster.Text);
                        FwMctMaster(sender, e, stringNum, mctNum, sRecord);
                        sRecord.Close();
                    }
                }
                MyMarshalToForm("AddItemToListBox", "Update MCT Master FW complete.");
            }
            else
            {
        ...
        public void FwMctMaster(object sender, EventArgs e, byte stringNum, byte mctNum, StreamReader sRec)
        {
            ...
            SendTxMessage(stringNum, mctNum, USB_CMD_SEND_MCT485);
            ...
            while ((line = sRec.ReadLine()) != null)
            {
                ...
                if (record[0] == 'S' && record[1] == '1' && line.Length >= 12)
                {
                    for (tries = 0; tries < 3; tries++)
                    {
                        ...
                        txBuffer[5] = mctNum;
                        txBuffer[6] = txPid;
                        len = (byte)(Conv2Hex(record[2], record[3]) - 3);
                        txBuffer[7] = (byte)(len + 9);
                        txBuffer[8] = MCT_CMD_PROG_APP;
                        txBuffer[9] = Conv2Hex(record[4], record[5]);
                        txBuffer[10] = Conv2Hex(record[6], record[7]);
                        addr = (((int)txBuffer[9]) << 8) + ((int)txBuffer[10]);
                        txBuffer[11] = len;
                        for (byte i = 0; i < len; i++)
                        {
                            flash = Conv2Hex(record[8 + i + i], record[9 + i + i]);
                            mctFlashMem[addr+i] = flash;
                            txBuffer[12 + i] = flash;
                        }
                        TxCrcCalc(5, (byte)(7 + len));
                        txBuffer[USB_PACKET_MCT] = mctNum;
                        txBuffer[USB_PACKET_LEN] = (byte)(7 + 9 + len);
                        SendTxMessage(stringNum, mctNum, USB_CMD_SEND_MCT485);
                        Mct485WaitResp(stringNum, mctNum);
                        if (rxBuffer[USB_PACKET_LEN] != 0x11 && rxBuffer[10] != 1)
                        {
                            if (tries < 2)
                            {
            ...
            TxCrcCalc(5, (byte)(7 + 4));
            txBuffer[USB_PACKET_MCT] = mctNum;
            txBuffer[USB_PACKET_LEN] = (byte)(7 + 9 + 4);
            SendTxMessage(stringNum, mctNum, USB_CMD_SEND_MCT485);
            Mct485WaitResp(stringNum, mctNum);
            //txBuffer[5] = mctNum;
            //txBuffer[6] = txPid;
            //txBuffer[7] = 6;
            //txBuffer[8] = MCT_CMD_FLASH_CKSUM;
            //TxCrcCalc(5, 4);
            //txBuffer[USB_PACKET_MCT] = mctNum;
            //txBuffer[USB_PACKET_LEN] = 13;
        ...
        public byte Conv2Hex(char a, char b)
        {
            byte hex;
        ...
        private void btnUpdateMctSlave_Click(object sender, EventArgs e)
        {
            ...
            if (File.Exists(txtFwSlave.Text))
            {
                ...
                for (byte stringNum = stringStart; stringNum <= stringStop; stringNum++)
                {
                    ...
                    for (byte mctNum = mctStart; mctNum <= mctStop; mctNum++)
                    {
                        StreamReader sRecord = File.OpenText(txtFwSlave.Text);
                        FwMctSlave(sender, e, stringNum, mctNum, sRecord);
                        sRecord.Close();
                    }
                }
                MyMarshalToForm("AddItemToListBox", "Update MCT Slave FW complete.");
            }
            else
            {
                MyMarshalToForm("AddItemToListBox", "Error: Could not read file from disk");
        ...
        public void FwMctSlave(object sender, EventArgs e, byte stringNum, byte mctNum, StreamReader sRec)
        {
            ...
            while ((line = sRec.ReadLine()) != null)
            {
                ...
                if (record[0] == 'S' && record[1] == '1' && line.Length >= 12)
                {
                    ...
                    txBuffer[13] = Conv2Hex(record[4], record[5]);
                    txBuffer[14] = Conv2Hex(record[6], record[7]);
                    txBuffer[15] = len;
                    for (byte i = 0; i < len; i++)
                    {
                        txBuffer[16 + i] = Conv2Hex(record[8 + i + i], record[9 + i + i]);
                    }
                    TxCrcCalc(9, (byte)(7 + len));
                    txBuffer[5] = mctNum;
                    txBuffer[6] = txPid;
                    txBuffer[7] = (byte)(15 + len);
                    txBuffer[8] = MCT_CMD_FWD_TO_SLAVE;
                    TxCrcCalc(5, (byte)(13 + len));
                    txBuffer[USB_PACKET_MCT] = mctNum;
                    txBuffer[USB_PACKET_LEN] = (byte)(6 + 7 + 9 + len);
                    SendTxMessage(stringNum, mctNum, USB_CMD_SEND_MCT485);
                    Mct485WaitResp(stringNum, mctNum);
                }
            }
        ...
        public Boolean Mct485WaitResp(byte str, byte mct)
        {
            for (int count = 0; count < 500; count++)
            {
                Application.DoEvents();
                System.Threading.Thread.Sleep(1);
                SendTxMessage(str, mct, USB_CMD_GET_MCT485);
                if (rxBuffer[USB_PACKET_LEN] > 7)
                {
                    return true;
                }
            }
            ...
            if (btnStartStop.Text == "Start")
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    for (int j = 0; j < 10; j++)
                    {
                        ...
                        {
                            // close open files
                            string fName = "MCT" + (j + 1).ToString() + " Str" + (char)((byte)'A' + i) + ' ';
        ...
        public void PollNextItem()
        {
            ...
            switch (pollState)
            {
                case POLL_LOG_FIELD_STATE: // 0
                    SendTxMessage(0, 0, USB_RESP_FIELD_STATE);
                    pollState = POLL_LOG_FCE;
                    break;

                case POLL_LOG_FCE:      // 1
                    SendTxMessage(0, 0, USB_CMD_GET_FCE);
                    pollState = POLL_LOG_RTU;
                    break;

                case POLL_LOG_RTU:      // 2
                    SendTxMessage(0, 0, USB_CMD_GET_RTU);
                ...
                case POLL_LOG_STRING:   // 4
                    SendTxMessage(pollStringNum, 0, USB_CMD_GET_STRING);
                    pollStringNum++;
                    if (pollStringNum >= 4)
                    {
                        pollStringNum = 0;
                ...
                case POLL_LOG_MCT_POSN: // 5
                    SendTxMessage(pollStringNum, (byte)(pollMctNum + 1), USB_CMD_GET_MIRRORS);
                    if (!NextPollMct())
                    {
                ...
                case POLL_LOG_MCT_CHAN: // 6
                    SendTxMessage(pollStringNum, (byte)(pollMctNum+1), USB_CMD_GET_CHAN);
                    if (!NextPollMct())
                    {
                        pollState = POLL_LOG_FIELD_STATE;
                        pollDataValid = true;
